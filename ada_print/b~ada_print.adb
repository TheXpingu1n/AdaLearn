pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~ada_print.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~ada_print.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_ada_print");
