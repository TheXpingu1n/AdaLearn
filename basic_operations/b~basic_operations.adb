pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~basic_operations.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~basic_operations.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_basic_operations");
